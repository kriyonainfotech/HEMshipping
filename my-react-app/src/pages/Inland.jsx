      ...
      <div className="min-h-screen overflow-x-hidden">
        ...
        <section className="relative h-[500px] flex items-center justify-center text-center overflow-hidden">
          <video
            ...
            playsInline
          >
            <source src="/port/inland.mp4" type="video/mp4" />
          </video>
          ...
          >
            Our Services / Inland Transportation
          </motion.h1>
        </section>
        ...
        <section className="bg-gradient-to-r from-gray-900 to-gray-600 text-white py-16">
          <div className="container mx-auto px-4 rounded-xl">
            <div className="container mx-auto px-6">
              {/* Heading */}
              <h2 className="text-4xl space text-center font-bold">
                Get in Touch
              </h2>
